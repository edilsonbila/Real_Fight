...
def desenhar_barra_de_vida(surface, cor, x, y, largura, altura, vida_atual, vida_total):
...
def jogo():
    ...
    while True:
        ...
        if comandos_p1["soco"]:
            acao_atual_p1 = "soco"  # Definir ação atual como "soco" ao detectar o comando

        # Verificar e aplicar soco para o jogador 2
        if comandos_p2["soco"]:
            acao_atual_p2 = "soco"  # Definir ação atual como "soco" ao detectar o comando
        ...
        desenhar_barra_de_vida(tela, VERMELHO, barra_x_p1, barra_y, barra_largura, barra_altura, vida_p1, 100)
        desenhar_barra_de_vida(tela, AZUL, barra_x_p2, barra_y, barra_largura, barra_altura, vida_p2, 100)
